import { WALLET_STANDARD_ERROR__FEATURES__WALLET_FEATURE_UNIMPLEMENTED, WalletStandardError, } from '@wallet-standard/errors';
...
describe('getWalletFeature', () => {
    ...
    it('throws if the handle provided does not support the feature requested', () => {
        ...
        }).toThrow(new WalletStandardError(WALLET_STANDARD_ERROR__FEATURES__WALLET_FEATURE_UNIMPLEMENTED, {

...
const UiWalletAccountRegistry_js_1 = require("../UiWalletAccountRegistry.js");
const UiWalletHandleRegistry_js_1 = require("../UiWalletHandleRegistry.js");
const UiWalletRegistry_js_1 = require("../UiWalletRegistry.js");
...
describe('getOrCreateUiWalletForStandardWallet', () => {
    ...
    it('returns a frozen object', () => {
        const uiWallet = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
    ...
    it('registers the Standard wallet associated with the UI wallet account with the wallet handle registry', () => {
        const uiWallet = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
        expect(UiWalletHandleRegistry_js_1.registerWalletHandle).toHaveBeenCalledWith(uiWallet, mockWallet);
    });
    it('returns the same UI wallet given the same underlying Standard wallet', () => {
        const uiWalletA = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
        const uiWalletB = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
        expect(uiWalletB).toBe(uiWalletA);
        expect(UiWalletHandleRegistry_js_1.registerWalletHandle).toHaveBeenCalledTimes(1);
    ...
    it('returns a UI wallet with a frozen list of UI wallet accounts', () => {
        ...
        jest.mocked(UiWalletAccountRegistry_js_1.getOrCreateUiWalletAccountForStandardWalletAccount).mockReturnValue(mockUiWalletAccount);
        const uiWallet = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
    ...
    it('returns a new UI wallet given the same underlying Standard wallet that mutated the accounts to add one', () => {
        ...
        expect(UiWalletHandleRegistry_js_1.registerWalletHandle).toHaveBeenCalledWith(uiWalletB, mockWallet);
    });
    ...
    it('returns a new UI wallet given the same underlying Standard wallet that mutated the accounts to modify one', () => {
        const uiWalletA = (0, UiWalletRegistry_js_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
        jest.mocked(UiWalletAccountRegistry_js_1.getOrCreateUiWalletAccountForStandardWalletAccount).mockReturnValue(
...
//# sourceMappingURL=uiWalletRegistry-test.js.map
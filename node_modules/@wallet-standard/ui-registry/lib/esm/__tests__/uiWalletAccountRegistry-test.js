...
describe('getOrCreateUiWalletAccountForStandardWalletAccount', () => {
    let mockWallet;
    ...
    it('returns a frozen object', () => {
        const uiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
    ...
    it('registers the Standard wallet associated with the UI wallet account with the wallet handle registry', () => {
        const uiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
        expect(registerWalletHandle).toHaveBeenCalledWith(uiWalletAccount, mockWallet);
    });
    it('returns the same UI wallet account given the same underlying Standard wallet account', () => {
        ...
        const uiWalletAccountA = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
        const uiWalletAccountB = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
    ...
    it('returns a different UI wallet account given a different underlying Standard wallet account', () => {
        jest.mocked(getWalletForHandle).mockReturnValue(mockWallet);
        const uiWalletAccountA = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
        jest.mocked(getWalletForHandle).mockReturnValue({ ...mockWallet } /* a different object */);
        const uiWalletAccountB = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
    ...
    it('returns a new UI wallet account given the same underlying Standard wallet account whose address has been mutated', () => {
        ...
        expect(registerWalletHandle).toHaveBeenCalledWith(uiWalletAccountB, mockWallet);
    });
    /**
     * Chains
     */
...
//# sourceMappingURL=uiWalletAccountRegistry-test.js.map
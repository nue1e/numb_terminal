import { getOrCreateUiWalletAccountForStandardWalletAccount, getOrCreateUiWalletForStandardWallet, } from '@wallet-standard/ui-registry';
...
describe('uiWalletAccountsAreSame()', () => {
    ...
    it('returns true if the addresses and underlying `Wallet` match, despite the objects being different', () => {
        const clonedMockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, {
            ...mockWalletAccount,
    ...
    it('returns false if the addresses match but the underlying `Wallet` does not', () => {
        const clonedMockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount({ ...mockWallet }, mockWalletAccount);
...
describe('uiWalletAccountBelongsToUiWallet()', () => {
    ...
    beforeEach(() => {
        ...
        mockUiWalletAccount = getOrCreateUiWalletAccountForStandardWalletAccount(mockWallet, mockWalletAccount);
        mockUiWallet = getOrCreateUiWalletForStandardWallet(mockWallet);
    });
    ...
    it('returns false if the UI wallet account does not belong to the UI wallet', () => {
        const differentWallet = { ...mockWallet }; /* different object */
        const identicalAccountInDifferentWallet = getOrCreateUiWalletAccountForStandardWalletAccount(differentWallet, mockWalletAccount);

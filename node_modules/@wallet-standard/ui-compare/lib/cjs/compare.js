...
function uiWalletAccountsAreSame(a, b) {
    ...
    const underlyingWalletA = (0, ui_registry_1.getWalletForHandle)(a);
    const underlyingWalletB = (0, ui_registry_1.getWalletForHandle)(b);
...
function uiWalletAccountBelongsToUiWallet(account, wallet) {
    const underlyingWalletForUiWallet = (0, ui_registry_1.getWalletForHandle)(wallet);
    const underlyingWalletForUiWalletAccount = (0, ui_registry_1.getWalletForHandle)(account);

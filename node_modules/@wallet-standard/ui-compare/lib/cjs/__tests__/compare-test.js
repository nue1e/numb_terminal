...
describe('uiWalletAccountsAreSame()', () => {
    ...
    beforeEach(() => {
        ...
        mockUiWalletAccount = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(mockWallet, mockWalletAccount);
    });
    ...
    it('returns true if the addresses and underlying `Wallet` match, despite the objects being different', () => {
        const clonedMockUiWalletAccount = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(mockWallet, Object.assign(Object.assign({}, mockWalletAccount), { chains: ['solana:danknet'] }));
    ...
    it('returns false if the addresses match but the underlying `Wallet` does not', () => {
        const clonedMockUiWalletAccount = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(Object.assign({}, mockWallet), mockWalletAccount);
    ...
    it('returns false if the addresses do not match even if the underlying `Wallet` does', () => {
        const clonedMockUiWalletAccount = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(mockWallet, Object.assign(Object.assign({}, mockWalletAccount), { address: 'xyz' }));
        expect((0, compare_js_1.uiWalletAccountsAreSame)(mockUiWalletAccount, clonedMockUiWalletAccount)).toBe(false);
    });
});
describe('uiWalletAccountBelongsToUiWallet()', () => {
    ...
    beforeEach(() => {
        ...
        mockUiWalletAccount = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(mockWallet, mockWalletAccount);
        mockUiWallet = (0, ui_registry_1.getOrCreateUiWalletForStandardWallet)(mockWallet);
    });
    ...
    it('returns false if the UI wallet account does not belong to the UI wallet', () => {
        ...
        const identicalAccountInDifferentWallet = (0, ui_registry_1.getOrCreateUiWalletAccountForStandardWalletAccount)(differentWallet, mockWalletAccount);

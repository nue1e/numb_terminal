...
interface GraphQLSimulateTransactionOptions<Include extends SuiClientTypes.SimulateTransactionInclude = {}> extends SuiClientTypes.SimulateTransactionOptions<Include> {
  /**
...
declare class SuiGraphQLClient<Queries extends Record<string, GraphQLDocument> = {}> extends BaseClient implements SuiClientTypes.TransportMethods {
  ...
  simulateTransaction<Include extends SuiClientTypes.SimulateTransactionInclude = {}>(input: GraphQLSimulateTransactionOptions<Include>): Promise<SuiClientTypes.SimulateTransactionResult<Include>>;
...
//#endregion
export { GraphQLDocument, GraphQLQueryOptions, GraphQLQueryResult, GraphQLResponseErrors, GraphQLSimulateTransactionOptions, SuiGraphQLClient, SuiGraphQLClientOptions, SuiGraphQLRequestError, isSuiGraphQLClient };

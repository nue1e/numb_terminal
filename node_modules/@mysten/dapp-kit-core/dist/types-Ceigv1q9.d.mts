...
type SignPersonalMessageArgs<TNetworks extends Networks = Networks> = {
  /** The account to sign with. Defaults to the currently connected account. */account?: UiWalletAccount; /** The network to sign against. Defaults to the dApp kit's current network. */
...
type SignAndExecuteTransactionArgs<TNetworks extends Networks = Networks> = {
  transaction: Transaction | string; /** The account to sign with. Defaults to the currently connected account. */
  account?: UiWalletAccount; /** The network to sign and execute against. Defaults to the dApp kit's current network. */
  network?: TNetworks[number];
...
type SignTransactionArgs<TNetworks extends Networks = Networks> = {
  transaction: Transaction | string; /** The account to sign with. Defaults to the currently connected account. */
  account?: UiWalletAccount; /** The network to sign against. Defaults to the dApp kit's current network. */
  network?: TNetworks[number];
...
type DAppKit<TNetworks extends Networks = [], Client extends DAppKitCompatibleClient = DAppKitCompatibleClient> = {
  ...
  signAndExecuteTransaction: (args: SignAndExecuteTransactionArgs<TNetworks>) => Promise<SignAndExecuteTransactionResult>;
...
//# sourceMappingURL=types-Ceigv1q9.d.mts.map
...
var transformCss_dist_vanillaExtractCssTransformCss = require('./transformCss-66ce4e57.browser.cjs.js');
...
function composedStyle(rules, debugId) {
  ...
  var joinedClassList = transformCss_dist_vanillaExtractCssTransformCss.dedupeAndJoinClassList(classList);
